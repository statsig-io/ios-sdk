// Code vendored from https://github.com/krzyzanowskim/CryptoSwift/blob/main/Sources/CryptoSwift/Checksum.swift
...
@usableFromInline
internal let table32: Array<UInt32> = [
...
@inlinable
internal func crc32(_ message: Data, seed: UInt32? = nil) -> UInt32 {
    var crc: UInt32 = seed ?? 0xFFFF_FFFF

    // Process message in chunks of 256 bytes
    let chunkSize = 256
    var offset = 0
